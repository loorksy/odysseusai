        ...
        if existing_file:
            ...
            if existing_file:
                return {
                    ...
                    "name": existing_file.get("original_name") or existing_file.get("name") or existing_file["id"],
                    "original_name": existing_file.get("original_name") or existing_file.get("name") or existing_file["id"],
                    "hash": file_hash,
